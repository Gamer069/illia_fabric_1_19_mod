...
public abstract class MeltedRubyFluid extends FlowableFluid {
	...
	protected int getFlowSpeed(WorldView world) {
		return world.getDimension().ultrawarm() ? 5 : 3;
	}
	@Override
	...
	public Fluid getStill() {
		return ModFluids.STILL_MELTED_RUBY_FLUID;
	}
	@Override
	public Fluid getFlowing() {
		return ModFluids.FLOWING_MELTED_RUBY_FLUID;
	}
	@Override
	...
	protected BlockState toBlockState(FluidState state) {
		return ModFluids.MELTED_RUBY_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
	}
